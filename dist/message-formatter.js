import { BLOCK_TYPES, COLORS, MESSAGES, TEST_STATUS, TEXT_TYPES, TITLES, } from './constants.js';
import { createTestResultBlocks, createMessageBlocks, createFlakyTestBlocks, createSingleAiTestBlocks, createAiTestBlocks, createFailedTestBlocks, createSingleFailedTestBlocks, } from './blocks.js';
/**
 ...
 */
export const formatResultsMessage = (ctrf, options) => {
 ...
 * @returns The formatted message
 */
export const formatFlakyTestsMessage = (ctrf, options) => {
 ...
 * @returns The formatted message
 */
export const formatAiTestSummary = (test, environment, options) => {
 ...
 * @returns The formatted message
 */
export const formatConsolidatedAiTestSummary = (tests, environment, options) => {
    const failedTests = tests.filter(test => test.ai !== undefined && test.status === TEST_STATUS.FAILED);
...
function handleBuildInfo(environment) {
    ...
    const buildName = process.env.BUILD_NAME ?? environment?.buildName ?? undefined;
    const buildNumber = process.env.BUILD_NUMBER ?? environment?.buildNumber ?? undefined;
    ...
    if (buildName !== undefined && buildNumber !== undefined) {
        const buildText = buildUrl !== undefined
 ...
 */
function normalizeOptions(defaultTitle, options) {
