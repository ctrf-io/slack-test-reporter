 ...
 */
export function uppercaseHelper() {
 ...
 */
export function escapeMarkdownHelper() {
    Handlebars.registerHelper('escapeMarkdown', (str) => {
 ...
 */
export function splitLinesHelper() {
 ...
 */
export function sliceStringHelper() {
    Handlebars.registerHelper('sliceString', (str, start, end) => {
...
export function convertTimestamp() {
    Handlebars.registerHelper('convertTimestamp', (timestamp) => {
        if (timestamp === '')
            return '';
